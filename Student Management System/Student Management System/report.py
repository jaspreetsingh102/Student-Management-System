...
class reportclass:
    def __init__(self,root):
        ...
        lbl_roll=Label(self.root,text="Roll Number",font=("goudy old style",15,'bold'),bg="white",bd=2,relief=GROOVE).place(x=150,y=230,width=150,height=50)
        ...
        lbl_full_makrs=Label(self.root,text="Total Marks",font=("goudy old style",15,'bold'),bg="white",bd=2,relief=GROOVE).place(x=750,y=230,width=150,height=50)
