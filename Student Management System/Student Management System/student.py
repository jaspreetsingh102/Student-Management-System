...
class studentClass:
    def __init__(self,root):
        ...
        lbl_addission=Label(self.root,text="Admission",font=("goudy old style",15,'bold'),bg="white").place(x=360,y=140)
        ...
        lbl_search_croll=Label(self.root,text="Roll No.",font=("goudy old style",15,'bold'),bg="white").place(x=720,y=60)
...
#==========================================================================================================
        ...
        try:
            if self.var_roll.get()=="":
                ...
                if row!=None:
                    ...
                    con.commit()
                    messagebox.showinfo("Success",f"Student added Successfully",parent=self.root)
                    self.show()
    ...
    def update(self):
        ...
        try:
            if self.var_roll.get()=="":
                messagebox.showerror("Error","Roll Numnber should be required",parent=self.root)
            else:
                cur.execute("select * from student where roll=?",(self.var_roll.get(),))
                row=cur.fetchone()
                if row==None:
                    ...
                    con.commit()
                    messagebox.showinfo("Success",f"Student Update Successfully",parent=self.root)
                    self.show()
