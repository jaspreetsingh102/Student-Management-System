...
class courseclass:
    def __init__(self,root):
        ...
        self.text_courseName=Entry(self.root,textvariable=self.var_course,font=("goudy old style",15,'bold'),bg="light yellow")
        self.text_courseName.place(x=150,y=60,width=200)

        text_duration=Entry(self.root,textvariable=self.var_duration,font=("goudy old style",15,'bold'),bg="light yellow").place(x=150,y=100,width=200)
        text_charges=Entry(self.root,textvariable=self.var_charges,font=("goudy old style",15,'bold'),bg="light yellow").place(x=150,y=140,width=200)
        ...
        text_search_courseName=Entry(self.root,textvariable=self.var_search,font=("goudy old style",15,'bold'),bg="light yellow").place(x=870,y=60,width=180)
        ...
        try:
            if self.var_course.get()=="":
                ...
                if row!=None:
                    ...
                    con.commit()
                    messagebox.showinfo("Success",f"Course added Successfully",parent=self.root)
                    self.show()
        ...
        try:
            if self.var_course.get()=="":
                ...
                if row==None:
                    ...
                    con.commit()
                    messagebox.showinfo("Success",f"Course Update Successfully",parent=self.root)
                    self.show()
